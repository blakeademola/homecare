...
!function (t, e) {
    ...
    var n = {
            ...
            hide: null,
            pick: null
        }, t = "undefined" != typeof window, e = t ? window : {}, i = !!t && "ontouchstart" in e.document.documentElement,
        c = "datepicker", r = "click.".concat(c), h = "focus.".concat(c), o = "hide.".concat(c), l = "keyup.".concat(c),
        d = "pick.".concat(c), a = "resize.".concat(c), u = "scroll.".concat(c), p = "show.".concat(c),
        f = "touchstart.".concat(c), g = "".concat(c, "-hide"), y = {}, m = 0, v = 1, w = 2,
    ...
    function F(t) {
        return "date" === (e = t, k.call(e).slice(8, -1).toLowerCase()) && !C(t.getTime());
        var e
    }
    ...
    function S(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1, i = String(Math.abs(t)),
            a = i.length, s = "";
    ...
    var I = /\d+/g, P = {
            show: function () {
                ...
                var i = this.options, a = i.monthsShort, s = i.months;
                ...
                return F(a) || (b(a) && (t = a.match(I) || []), F(a = a ? new Date(a) : new Date) || (a = new Date), t.length === s.parts.length && D.each(t, function (t, e) {
                    var i = parseInt(e, 10);
                    switch (s.parts[t]) {
                        case"dd":
                        case"d":
                ...
                var e = this.format, i = "", o = this.options;

                if (F(t)) {

                    var a = t.getFullYear(), s = t.getMonth(), n = t.getDate(),
                        r = {d: n, dd: S(n, 2), m: s + 1, mm: S(s + 1, 2), M: o.monthsShort[s], MM: o.months[s], yy: String(a).substring(2), yyyy: S(a, 4)};
            ...
            click: function (t) {
                var e = D(t.target), i = this.options, a = this.date, s = this.viewDate, n = this.format;
                if (t.stopPropagation(), t.preventDefault(), !e.hasClass("disabled")) {
                    var r = e.data("view"), h = s.getFullYear(), o = s.getMonth(), l = s.getDate();
                    switch (r) {
                        case"years prev":
                        case"years next":
                        ...
                        case"year current":
                            ...
                            break;
                        case"year picked":
                            n.hasMonth ? this.showView(v) : (e.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("year");
                            break;
                        case"year":
                            h = parseInt(e.text(), 10), a.setFullYear(h), a.setDate(V(h, o, l)), s.setFullYear(h), s.setDate(V(h, o, l)), n.hasMonth ? this.showView(v) : (e.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("year");
                            break;
                        case"month prev":
                        case"month next":
                        ...
                        case"month current":
                            ...
                            break;
                        case"month picked":
                            n.hasDay ? this.showView(m) : (e.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("month");
                            break;
                        case"month":
                            o = D.inArray(e.text(), i.monthsShort), a.setFullYear(h), a.setDate(V(h, o, l)), a.setMonth(o), s.setFullYear(h), s.setDate(V(h, o, l)), s.setMonth(o), n.hasDay ? this.showView(m) : (e.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("month");
                            break;
                        case"day prev":
                        case"day next":
                        case"day":
                ...
                var e = t.target, i = t.key, a = t.keyCode;
            ...
            render: function () {
                ...
                var i = this, a = [], t = this.options, e = t.weekStart, s = t.daysMin;
                ...
                var t, e = this.options, i = this.startDate, a = this.endDate, s = e.disabledClass, n = e.filter,
                    r = e.yearSuffix, h = this.viewDate.getFullYear(), o = (new Date).getFullYear(),
                    l = this.date.getFullYear(), c = [], d = !1, u = !1;
                for (t = -5; t <= 6; t += 1) {
                    var p = new Date(h + t, 1, 1), f = !1;
                    i && (f = p.getFullYear() < i.getFullYear(), -5 === t && (d = f)), !f && a && (f = p.getFullYear() > a.getFullYear(), 6 === t && (u = f)), !f && n && (f = !1 === n.call(this.$element, p, "year"));
                    var g = h + t === l, y = g ? "year picked" : "year";
                ...
                var t, e = this.options, i = this.startDate, a = this.endDate, s = this.viewDate, n = e.disabledClass || "",
                    r = e.monthsShort, h = D.isFunction(e.filter) && e.filter, o = s.getFullYear(), l = new Date,
                    c = l.getFullYear(), d = l.getMonth(), u = this.date.getFullYear(), p = this.date.getMonth(), f = [],
                    g = !1, y = !1;
                for (t = 0; t <= 11; t += 1) {
                    var m = new Date(o, t, 1), v = !1;
                    ...
                    var w = o === u && t === p, k = w ? "month picked" : "month";
                ...
                var t, e, i, a = this.$element, s = this.options, n = this.startDate, r = this.endDate, h = this.viewDate,
                    o = this.date, l = s.disabledClass, c = s.filter, d = s.months, u = s.weekStart, p = s.yearSuffix,
                    f = h.getFullYear(), g = h.getMonth(), y = new Date, m = y.getFullYear(), v = y.getMonth(),
                    w = y.getDate(), k = o.getFullYear(), D = o.getMonth(), b = o.getDate(), C = [], $ = f, x = g, F = !1;
                0 === g ? ($ -= 1, x = 11) : x -= 1, t = G($, x);
                var M = new Date(f, g, 1);
                for ((i = M.getDay() - parseInt(u, 10) % 7) <= 0 && (i += 7), n && (F = M.getTime() <= n.getTime()), e = t - (i - 1); e <= t; e += 1) {
                    var Y = new Date($, x, e), V = !1;
        ...
        }, q = "".concat(c, "-top-left"), A = "".concat(c, "-top-right"), O = "".concat(c, "-bottom-left"),
        W = "".concat(c, "-bottom-right"), z = [q, A, O, W].join(" "), J = function () {
            function i(t) {
                ...
                !function (t, e) {
                    ...
                    var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], i = D(t),
                        a = i.css("position"), s = "absolute" === a, n = e ? /auto|scroll|hidden/ : /auto|scroll/,
            ...
            return t = i, a = [{
                key: "setDefaults", value: function () {
                    ...
                    D.extend(n, y[t.language], D.isPlainObject(t) && t)
                }
            }], (e = [{
                key: "init", value: function () {
                    var t = this.$element, e = this.options, i = e.startDate, a = e.endDate, s = e.date;
                    this.$trigger = D(e.trigger), this.isInput = t.is("input") || t.is("textarea"), this.inline = e.inline && (e.container || !this.isInput), this.format = function (i) {
                        ...
                        var t = String(i), e = t.match(T);
                        if (!e || 0 === e.length) throw new Error("Invalid date format.");

                        return i = {source: t, parts: e}, D.each(e, function (t, e) {
                ...
                key: "build", value: function () {
                    if (!this.built) {
                        this.built = !0;
                        var t = this.$element, e = this.options, i = D(e.template);
                ...
                key: "bind", value: function () {
                    ...
                    D.isFunction(t.show) && e.on(p, t.show), D.isFunction(t.hide) && e.on(o, t.hide), D.isFunction(t.pick) && e.on(d, t.pick), this.isInput && e.on(l, D.proxy(this.keyup, this)), this.inline || (t.trigger ? this.$trigger.on(r, D.proxy(this.toggle, this)) : this.isInput ? e.on(h, D.proxy(this.show, this)) : e.on(r, D.proxy(this.show, this)))
                }
            }, {
                key: "unbind", value: function () {
                    var t = this.$element, e = this.options;
                    D.isFunction(e.show) && t.off(p, e.show), D.isFunction(e.hide) && t.off(o, e.hide), D.isFunction(e.pick) && t.off(d, e.pick), this.isInput && t.off(l, this.keyup), this.inline || (e.trigger ? this.$trigger.off(r, this.toggle) : this.isInput ? t.off(h, this.show) : t.off(r, this.show))
                }
            }, {
                ...
                key: "place", value: function () {
                    if (!this.inline) {
                        var t = this.$element, e = this.options, i = this.$picker, a = D(document).outerWidth(),
                            s = D(document).outerHeight(), n = t.outerWidth(), r = t.outerHeight(), h = i.width(),
                            o = i.height(), l = t.offset(), c = l.left, d = l.top, u = parseFloat(e.offset), p = q;
                ...
                key: "createItem", value: function (t) {
                    var e = this.options, i = e.itemTag,
                        a = {text: "", view: "", muted: !1, picked: !1, disabled: !1, highlighted: !1}, s = [];
                ...
                key: "setValue", value: function () {
                    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", e = this.$element;
    ...
    if (D.extend && D.extend(J.prototype, j, N, P), D.fn) {
        ...
        D.fn.datepicker = function (h) {
            ...
            return this.each(function (t, e) {
                var i = D(e), a = "destroy" === h, s = i.data(c);
                if (!s) {
                    if (a) return;
